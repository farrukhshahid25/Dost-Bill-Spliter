...
☕ Java: 17+ | 🖥️ GUI: Java Swing | 🧪 Testing: JUnit 5
...
## ✨ Key Features
- **⚖️ Equal Splitting:** Quickly divide a total bill equally among a specified number of friends.
...
- **🖨️ Realistic Thermal Receipt:** A dynamic, visually accurate receipt generated on the right-hand panel for immediate visual feedback.
...
3. **🏗️ Code Refactoring & OOP Principles**
